...
>
							...
							while ( $the_query->have_posts() ) {
								...
								<div class="col-12 parent" sm="col-6" lg="col-4">
									...
									<div class="text-center p-relative">
										...
										>
											<a href="#" class="ml-6 ts-(0.5s)" hover="pb-(10px)"
											><i
											...
											if ( in_array( get_current_user_id(), $existing_pms ) ) {
												?>
												<a id="deletewishlist" class="ml-6 ts-(0.5s)" hover="pb-(10px)"
												>
												...
												?>
												<a id="addwishlist" class="ml-6 ts-(0.5s)" hover="pb-(10px)"
												>
													<input type="hidden" name="post_id"
													       value="<?php echo $post->ID; ?>">
													<i
			...
			<div class="col-12 order-1 mb-16" lg="col-3 order">
				...
				<div class="opener d-none" lg="d-block">
					...
					<div class="colors mt-(35px)">
						...
						<div id="colors">
							<form class="d-flex gap-3 dir-with-pad" action="<?php echo $current_url; ?>" method="get">
								<?php
	...
	<div class="pagination mt-(180px) bg-red pa-(60px)">
		<?php
		$arg = array(
			'post_type'      => 'product',
			'posts_per_page' => 2,
		...
		$kir = new WP_Query( $arg );


		if ( $kir->have_posts() ) {
			while ( $kir->have_posts() ) {
				$kir->the_post();

				?>
				<div class="bg-blue pa-(8px)">
