<div class="menu-container p-fixed top-0 z-99999999 left-0 right-0 d-flex" m-ignore-observe="children">
 ...
 <?php 
    ...
    <div class="menu" m-ignore-observe="children">
        ...
        <ul class="clearfix" m-ignore-observe="children">
            ...
            ?>
                        <li m-ignore-observe="children"><a href="<?php echo $item->url ?>"><?php echo $item->title ?></a>
                            <?php

                            if ($item->child_items > 0) {

                            ?>
                                <ul m-ignore-observe="children">
                                    <?php
                                    foreach ($item->child_items as $bib) {
                                    ?>
                                        <li m-ignore-observe="children"><a href="<?php echo $bib->url; ?>"><?php echo $bib->title; ?></a>
